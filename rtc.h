...
extern volatile unsigned long int rtc_periodic;   
extern volatile unsigned long int rtc_update;
extern volatile unsigned long int rtc_alarm;
extern volatile unsigned long int rtc_ints;
...
void printf_alarm(RTC_TIME *atime, int mode);
